...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Connect = QtWidgets.QPushButton(self.groupBox_motor)
        self.Connect.setGeometry(QtCore.QRect(350, 40, 151, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_Ch1.setText(_translate("MainWindow", "Канал 1"))
        self.btn_Autorecord.setText(_translate("MainWindow", "Авто"))
        self.btn_StartRecord.setText(_translate("MainWindow", "Начать запись"))
        self.lbl_Ch2.setText(_translate("MainWindow", "Канал 2"))
        self.lbl_Ch3.setText(_translate("MainWindow", "Канал 3"))
        self.lbl_Ch4.setText(_translate("MainWindow", "Канал 4"))
