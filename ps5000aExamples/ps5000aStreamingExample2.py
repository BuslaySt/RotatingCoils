...
# range = PS5000A_2V = 7
# analogue offset = 0 V
channel_range = ps.PS5000A_RANGE['PS5000A_200MV']
...
enabled = 1
# logicLevel = 10000
status["SetDigitalPort"] = ps.ps5000aSetDigitalPort(chandle, digital_port0, enabled, 10000)
assert_pico_ok(status["SetDigitalPort"])

# Size of capture
sizeOfOneBuffer = 500
numBuffersToCapture = 80
...
bufferDProt0Max = np.zeros(shape=sizeOfOneBuffer, dtype=np.int16)
